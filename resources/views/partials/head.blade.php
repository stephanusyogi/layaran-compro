...
<title>Layaran - Real-Time Messages, Real-Time Connections!</title>

<!-- Favicons -->
<link href="{{ asset('assets/images/logo-2.jpg') }}" rel="icon">
<link href="{{ asset('assets/images/logo-2.jpg') }}" rel="apple-touch-icon">
